            ...
            return (
                <div className="min-h-screen bg-slate-900 text-white p-10 flex flex-col items-center justify-center">
                    ...
                    <div className="bg-slate-800 p-6 rounded-lg max-w-2xl w-full overflow-auto border border-slate-700">
                        <h2 className="text-xl font-mono text-amber-400 mb-2">{this.state.error && this.state.error.toString()}</h2>
                    ...
                    <button
                        ...
                        className="mt-8 px-6 py-3 bg-teal-500 text-slate-900 font-bold rounded-lg hover:bg-teal-400 transition-colors"
                    >
                        Reload Page
                    </button>
                </div>
